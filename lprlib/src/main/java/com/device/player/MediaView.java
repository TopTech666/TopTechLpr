...
public class MediaView extends GLSurfaceView{
    ...
    private VideoSetView mVideoSetView;
    ...
    public MediaView(Context context, int dataSourceType) {
        super(context);
    ...
    public void setVideoView(VideoSetView videoView){
        this.mVideoSetView = videoView;
    }

    public void videoViewLongTimeNoData(){
        if(mVideoSetView != null){
            mVideoSetView.longTimeNoData();
        }
    }
...
//			mediaInfo = null;
        ...
        private class DecodeThread extends Thread {
            ...
            public void run() {
                ...
                while (isDecode) {
                    try {
                        if(isPause && dataSourceType== MediaView.TYPE_FILE) {
                            Thread.sleep(10);
                            continue;
                        }
                        decode();
